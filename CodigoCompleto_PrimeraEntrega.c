...
struct datosImputados {
    char *declaracion;
    int medidasCautelar; /**1 = Prision Preventiva, 2 = Arraigo nacional, 3 = firma periodica,
...
struct datosCarpeta { //datos investigativos (NO PERSONAS) singular de 1 tipo de dato
    char *fecha; //fecha
    char *descripcion; //descripcion generica
    struct persona *datosPersona;
...
/**===========================================================
 *SECCION FUNCIONES BUSCAR (TODOS)
===========================================================**/
...
/**===========================================================
 *SECCION FUNCIONES AGREGAR (DIEGO CORTEZ)
===========================================================**/
...
void agregarCarpetaInvestigativa(struct nodoDatosCarpetas **carpetas, struct datosCarpeta *nuevaCarpeta) {
    ...
    struct nodoDatosCarpetas *nuevoNodo = (struct nodoDatosCarpetas *)malloc(sizeof(struct nodoDatosCarpetas));
    if(nuevoNodo == NULL){
    ...
    // Si esta vacia asignar al inicio
    if(*carpetas == NULL){
        *carpetas = nuevoNodo;
    } else {
        ...
        // al encontrar final, se asignan los punteros al nuevo nodo
...
/**===========================================================
 *SECCION FUNCIONES ELIMINAR (RAFAEL VALDES)
===========================================================**/
...
void mostrarCausasEstado(struct ministerio *ministerio) {
    ...
    while (opcion != 0)
        ...
        switch (opcion) {
            case 1:
                // Recorre la lista circular mostrando todas las causas y su estado
            ...
            case 2:
                // Pide estado a filtrar y muestra solo esas causas
                ...
                if (contador == 0) {
                    printf("No se encontraron causas con ese estado.\n");
                }
                contador = 0;
                break;
            case 0:
...
/**===========================================================
 *SECCION FUNCIONES MODIFICAR (MAURICIO MORALES)
===========================================================**/
...
/**===========================================================
 *SECCION FUNCIONES MOSTRAR (CRISTOBAL FLORES)
===========================================================**/
    ...
    while (opcion != 0) {
        ...
        switch (opcion) {
            ...
            case 3:
                ...
                struct persona *persona = buscarPersonaPorRut(ministerio->personas, rut);
                if (persona == NULL)
            ...
            case 4:
                menuEliminarCarpeta(ministerio); //antes usaba &
                break;
